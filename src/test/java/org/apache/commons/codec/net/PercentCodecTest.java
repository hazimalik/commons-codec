 ...
 */
 ...
 public class PercentCodecTest {
     ...
     @Test
     @Disabled("This test is disabled because space encoding behavior may vary or is not fully implemented.")
     ...
     public void testDecodeInvalidEncodedResultDecoding() throws Exception {
         ...
         assertThrows(DecoderException.class, () -> percentCodec.decode(Arrays.copyOf(encoded, encoded.length - 1)));
     }
     ...
     public void testPercentEncoderDecoderWithNullOrEmptyInput() throws Exception {
         ...
         assertArrayEquals(emptyInput, percentCodec.encode(emptyInput), "Empty input value encoding test");
